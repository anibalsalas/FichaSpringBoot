...
@Entity
@Table(name = "educa_ficha2_s5_gabinete", schema = "SIGA")
public class Educa_Ficha2_S5_9Entity implements Serializable {
    
     @EmbeddedId
    private Educa_Ficha2_S5_9PkEntity educa_ficha2_s5_9pk;
   ...
   @Column(name = "p2_9_cantidad_total")
    ...
    public Educa_Ficha2_S5_9Entity() {
    }

    public Educa_Ficha2_S5_9PkEntity getEduca_ficha2_s5_9pk() {
        return educa_ficha2_s5_9pk;
    }

    public void setEduca_ficha2_s5_9pk(Educa_Ficha2_S5_9PkEntity educa_ficha2_s5_9pk) {
        this.educa_ficha2_s5_9pk = educa_ficha2_s5_9pk;
    }
