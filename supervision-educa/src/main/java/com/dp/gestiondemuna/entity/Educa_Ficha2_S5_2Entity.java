...
@Entity
@Table(name = "educa_ficha2_s5_edificaciones", schema = "SIGA")
public class Educa_Ficha2_S5_2Entity implements Serializable {
    
     @EmbeddedId
    private Educa_Ficha2_S5_2PkEntity educa_ficha2_s5_2pk;
    ...
    private Integer p2_2_tiempo;
    private String p2_2_certificado_inspeccion;
    ...
    public Educa_Ficha2_S5_2Entity() {
    }

    public Educa_Ficha2_S5_2PkEntity getEduca_ficha2_s5_2pk() {
        return educa_ficha2_s5_2pk;
    }

    public void setEduca_ficha2_s5_2pk(Educa_Ficha2_S5_2PkEntity educa_ficha2_s5_2pk) {
        this.educa_ficha2_s5_2pk = educa_ficha2_s5_2pk;
    }
    ...
    public Integer getP2_2_tiempo() {
        return p2_2_tiempo;
    }

    public void setP2_2_tiempo(Integer p2_2_tiempo) {
        this.p2_2_tiempo = p2_2_tiempo;
    }

    public String getP2_2_certificado_inspeccion() {
        return p2_2_certificado_inspeccion;
    }

    public void setP2_2_certificado_inspeccion(String p2_2_certificado_inspeccion) {
        this.p2_2_certificado_inspeccion = p2_2_certificado_inspeccion;
    }
