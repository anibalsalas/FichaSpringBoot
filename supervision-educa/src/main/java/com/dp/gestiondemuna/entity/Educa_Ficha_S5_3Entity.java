...
@Entity
@Table(name = "educa_ficha_s5_se", schema = "SIGA")
public class Educa_Ficha_S5_3Entity implements Serializable {
    
     @EmbeddedId
    private Educa_Ficha_S5_3PkEntity educa_ficha_s5_3pk;
   ...
   private String p2_3_terreno;
    ...
    public Educa_Ficha_S5_3Entity() {
    }

    public Educa_Ficha_S5_3PkEntity getEduca_ficha_s5_3pk() {
        return educa_ficha_s5_3pk;
    }

    public void setEduca_ficha_s5_3pk(Educa_Ficha_S5_3PkEntity educa_ficha_s5_3pk) {
        this.educa_ficha_s5_3pk = educa_ficha_s5_3pk;
    }
