...
@Entity
@Table(name = "educa_padron2", schema = "SIGA")
public class Demuna_EstablecimientosEntity2 implements Serializable {
   ...
   private String c_tipo_entidad; 
    ...
    public Demuna_EstablecimientosEntity2() {
    }
    
    // Constructor adicional que acepta dos parámetros de tipo String
    public Demuna_EstablecimientosEntity2(String nom_entidad, String cod_unico) {
