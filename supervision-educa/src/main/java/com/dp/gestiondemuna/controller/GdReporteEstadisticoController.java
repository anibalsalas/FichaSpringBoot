...
import com.dp.gestiondemuna.dto.GdReporteEstadisticoDTO;
...
public class GdReporteEstadisticoController {
    ...
    @RequestMapping("/demuna/especialista/reporte/reportesEstadisticos")
    public String mostrarFormularioReporteEstadisticoController(ModelMap model) {

        model.addAttribute("listaReporte", listarReportes());

        return "gestiondemuna/especialista/reporte/reportesEstadisticos";
    }
