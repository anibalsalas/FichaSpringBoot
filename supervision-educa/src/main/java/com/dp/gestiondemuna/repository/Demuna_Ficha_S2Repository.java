...
public interface Demuna_Ficha_S2Repository extends JpaRepository<Demuna_Ficha_S2Entity, Integer> {
    ...
    @Transactional
    @Modifying
    @Query(value = "update siga.educa_ficha_S2 f set f.estado_s2 = '1', f.usu_valida=:usu_valida, f.fch_valida=sysdate where f.id_ficha=:id_ficha and f.id_ficha_s2=:id_ficha_s2", nativeQuery = true)
